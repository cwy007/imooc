...
var patterns = {
  ...
  // p_high: /\d+[a-zA-Z]+[^\s\da-zA-Z]|\d+[^\s\da-zA-Z]+[a-zA-Z]|[a-zA-Z]+[^\s\da-zA-Z]+\d|[a-zA-Z]+\d+[^\s\da-zA-Z]|[^\s\da-zA-Z]+\d+[a-zA-Z]|[^\s\da-zA-Z]+[a-zA-Z]+\d/, //是三种类型的结合，那么密码强度为高
  p_high: /\d+|[a-zA-Z]+|[^\s\da-zA-Z]+/, //是三种类型的结合，那么密码强度为高
