(function($) {
    ...
    Dropdown.prototype._init=function () { console.log(1);
        var self=this;
    ...
    $.fn.extend({
        dropdown: function(option) {
            return this.each(function() {
                ...
                options = $.extend({}, Dropdown.DEFAULTS, $(this).data(), typeof option==='object'&&option); // false 不参与对象合并
                // dropdown(this, options);
                if(!dropdown){//解决多次调用dropdown问题
                    $this.data('dropdown',dropdown=new Dropdown($this,options));
                }
              // $this.data('dropdown1', 'cwy'); // 不会在html上显示出来
